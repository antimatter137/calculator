exports.handler = async (event) => {
    ...
    const parameterPrefix = "Parameters: You answer all kinds math questions. If decimal does not end write it as a fraction unless told not to. Never use markdown except for headers, lists, bolding and italicizing. Question:";
