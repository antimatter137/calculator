exports.handler = async (event) => {
    ...
    const parameterPrefix = "Parameters: You answer all kinds math questions. If decimal does not end write it as a fraction unless told not to. Never use markdown for anything other than spacing and lists because it appears broken. i installed mathjax so you must LaTeX formatting. Question:";
